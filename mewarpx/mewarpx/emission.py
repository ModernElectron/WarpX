...
class PlasmaInjector(Injector):
    ...
    def __init__(self, emitter, species1, species2, npart, T_2=None,
        ...
        Arguments:
            emitter (:class:`mewarpx.emission.Emitter`): BaseEmitter object
                that will specify positions and velocities of particles to
                inject.
            species1 (mepicmi.Species): First species, eg electron
            species2 (mepicmi.Species): Second species, eg ion
        ...
        if isinstance(self.emitter, Emitter):
            ...
            print(
                f"  full weight {self.species1.sw*self.weight:.4g}, surface "
                f"density {self.plasma_density:.4g} m^-2, area "
